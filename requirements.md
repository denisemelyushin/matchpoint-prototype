...
- **Forward navigation into any sub-screen** (e.g. opening a post, opening a chat, opening the profile, entering a create flow, viewing Privacy or Terms) plays a **slide-in-from-right** transition so navigation feels native and smooth. The animation is disabled when the OS signals *reduced motion*.
